        ...
        with c2:
            ...
            if q:
                with st.spinner("AI đang soi số liệu..."):
                    ...
                    context = (
                        f"Tháng gần nhất: Doanh thu {last['Doanh Thu']:,.0f}, "
                        f"Giá Vốn {last.get('Giá Vốn', 0):,.0f}, "
                        f"CP Lương {last.get('CP Lương', 0):,.0f}, "
                        f"CP Marketing {last.get('CP Marketing', 0):,.0f}, "
                        f"CP Khác {last.get('CP Khác', 0):,.0f}, "
                        f"Tổng Chi Phí VH {last.get('Chi Phí VH', 0):,.0f}, "
                        f"Lợi nhuận {last['Lợi Nhuận ST']:,.0f}. "
                        f"Tháng trước đó: Doanh thu {prev['Doanh Thu']:,.0f}, "
                        f"Chi Phí VH {prev.get('Chi Phí VH', 0):,.0f}, "
                        f"Lợi nhuận {prev['Lợi Nhuận ST']:,.0f}."
                    )
